...
const textOnlyChatHistory = [
  {
    ...
    Nickname: TantaiHaha4487/แทนทัย can call Tantai/แทน
    Name: Thanachot Phomthong (ธนโขติ พรมทอง)
    Age: 16 year old.
    MBTI: ENFP    
    Gender: Male
    Region: Thailand
...
module.exports = { textOnlyChatHistory }